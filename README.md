...
<img width="100"  alt="Simulator Screenshot - iPhone 17 - 2026-05-05 at 14 38 19" src="https://github.com/user-attachments/assets/44368db1-4816-414b-be30-bd9262bf5614" />
...
・発表、もうすぐなのに専門用語があやしい
・復習しようと思ってたのに、気づいたら前日

MAIORAL（マイオーラル）は、
そんな「発表前、時間ない！」を助けるアプリです。

やることはシンプル。
作る → 覚える → 確認する → 話せるようにする。

## 主な機能
・デッキ作成（手入力 / CSV / PDF / PPTX）
・フラッシュカード学習
・クイズで理解度チェック
・聞き流し（英訳→和訳、英訳のみ、ループ、再生間隔）
・通知でランダム単語リマインド
・発表向けリハーサル
